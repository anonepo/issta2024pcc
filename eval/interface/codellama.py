...
class CodeLLamaInterface:
    def __init__(self, model_id, total_budget=4096, max_rag_num=1):
    ...
    def gen_prompt(self, context) -> str:
        ...
        prefix_input = {idx: context[idx] for idx, budget in self.prefix_structure}
        suffix_input = {idx: context[idx] for idx, budget in self.suffix_structure}
    ...
    def manage_prompt_size(
        ...
        tokenized_context = self.encode_infilling(init_context)
        for key, key_budget in structure:
            ...
            if key == "rag":
                ...
                for content in context_content:
                    ...
                    tokenized_content = self.encode_infilling(context)
                ...
                tokenized_content = self.encode_infilling(context_content)
        ...
        context_input = tokenizer.decode(tokenized_context)
